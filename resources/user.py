...
EMAIL_ALREADY_EXISTS = "A email with that username already exists."
...
SUCCESS_REGISTER_MESSAGE = "Account created successfully, an email with an activation link has sent to " \
...
class UserLogin(Resource):
    ...
    def post(cls):
        ...
        return gettext("user_invalid_credentials"), 401
