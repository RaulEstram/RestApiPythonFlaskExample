...
FAILED_LOAD_DOMAIN = "Failed to load Mailgun API key"
...
class Mailgun:
    MAILGUN_DOMAIN = os.environ.get("MAILGUN_DOMAIN")  # puede ser None
    MAILGUN_API_KEY = os.environ.get("MAILGUN_API_KEY")  # puede ser None
    FROM_TITLE = "Stores REST API"
    FROM_EMAIL = "team_uwu@uwu.com"
